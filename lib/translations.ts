...
const translations = {
  ...
  'pricing.growth.note': {
    ...
    EL: 'Ένα site μόνο δεν αρκεί — έτσι πραγματικά αναπτύσσεστε. Η κάλυψη social media περιλαμβάνει στρατηγική και δημοσιεύσεις, όχι δημιουργία περιεχομένου. Ελάχιστη διάρκεια συμβολαίου 3 μήνες.',
