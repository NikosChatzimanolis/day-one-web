...
export function PhoneShot({ src, sizes = '280px', priority = false, className }: ShotProps) {
  return (
    <div
      className={cn('relative h-full aspect-[387/782] bg-[#242320] p-[1.6%]', className)}
      style={{ borderRadius: '12% / 5.9%', containerType: 'inline-size' }}
    >
      {/* side buttons */}
      <span aria-hidden="true" className="absolute -left-[1.1%] top-[15%] h-[3.2%] w-[1.1%] rounded-l-[2px] bg-[#242320]" />
      <span aria-hidden="true" className="absolute -left-[1.1%] top-[20.5%] h-[5.5%] w-[1.1%] rounded-l-[2px] bg-[#242320]" />
      <span aria-hidden="true" className="absolute -left-[1.1%] top-[27.5%] h-[5.5%] w-[1.1%] rounded-l-[2px] bg-[#242320]" />
      <span aria-hidden="true" className="absolute -right-[1.1%] top-[22%] h-[8.5%] w-[1.1%] rounded-r-[2px] bg-[#242320]" />

      <div className="relative flex h-full w-full flex-col overflow-hidden bg-[#F5F6EF]" style={{ borderRadius: '10.8% / 5.3%' }}>
        {/* status bar */}
        <div className="flex h-[5.7%] shrink-0 items-center justify-between px-[7%] text-[#242320]" style={{ fontSize: '3.6cqw' }}>
          ...
          <span className="flex items-center" style={{ gap: '1.6cqw' }}>
            <span className="flex items-end" style={{ gap: '0.6cqw' }}>
              <span className="block bg-[#242320]" style={{ width: '0.9cqw', height: '1.4cqw', borderRadius: '0.3cqw' }} />
              <span className="block bg-[#242320]" style={{ width: '0.9cqw', height: '2cqw', borderRadius: '0.3cqw' }} />
              <span className="block bg-[#242320]" style={{ width: '0.9cqw', height: '2.6cqw', borderRadius: '0.3cqw' }} />
              <span className="block bg-[#242320]" style={{ width: '0.9cqw', height: '3.2cqw', borderRadius: '0.3cqw' }} />
            </span>
            <span
              className="relative block border border-[#242320]"
              style={{ width: '6.4cqw', height: '3.1cqw', borderRadius: '0.9cqw', padding: '0.5cqw' }}
            >
              <span className="block h-full w-[78%] bg-[#242320]" style={{ borderRadius: '0.4cqw' }} />
            </span>
          </span>
        </div>
        {/* island */}
        <span
          aria-hidden="true"
          className="absolute left-1/2 top-[1.5%] h-[3.3%] w-[27%] -translate-x-1/2 rounded-full bg-[#242320]"
        />
        {/* screen */}
