    ...
    <section className="bg-bg">
      <div className="container-wide py-8 md:py-10">
        <Reveal>
          ...
          >
            <span className="font-body text-base text-text-primary md:border-r md:border-border md:pr-8">{c.title}</span>
            <span className="flex-1 font-body text-sm leading-relaxed text-text-secondary">{c.body}</span>
