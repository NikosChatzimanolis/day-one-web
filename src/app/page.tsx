      ...
      <header className="fixed w-full top-0 bg-white/90 backdrop-blur-md z-40 border-b border-gray-100 transition-all">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#services" className="text-sm font-medium text-gray-600 hover:text-purple-700 transition-colors">Services</a>
            <a href="#portfolio" className="text-sm font-medium text-gray-600 hover:text-purple-700 transition-colors">Work</a>
            <a href="#pricing" className="text-sm font-medium text-gray-600 hover:text-purple-700 transition-colors">Pricing</a>
            <a href="#process" className="text-sm font-medium text-gray-600 hover:text-purple-700 transition-colors">Process</a>
            <a 
              href="#contact" 
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 w-full bg-white border-b border-gray-100 shadow-lg py-4 px-6 flex flex-col gap-4">
            <a href="#services" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Services</a>
            <a href="#portfolio" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Work</a>
            <a href="#pricing" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Pricing</a>
            <a href="#process" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-gray-800">Process</a>
            <a href="#contact" onClick={() => setIsMobileMenuOpen(false)} className="bg-purple-700 text-white text-center py-3 rounded-lg font-medium mt-2">Get in Touch</a>
          </div>
        )}
      </header>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-gray-900 mb-6 leading-[1.1]">
            Everything your business needs <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-purple-500">online.</span>
          </h1>
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            From websites and social media to photography and brand presence — we handle everything. Stop juggling freelancers and start growing.
          </p>
      ...
      <section id="services" className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Complete Digital Presence</h2>
            <p className="text-gray-600 text-lg">We provide end-to-end solutions so you can focus on running your business, not managing digital tools.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-2xl p-8 border border-purple-100 flex flex-col items-center justify-center text-center">
               <h3 className="text-xl font-bold text-purple-900 mb-2">Need a custom solution?</h3>
               <p className="text-purple-700/80 mb-4">We offer tailored consulting and strategy.</p>
               <a href="#contact" className="text-purple-700 font-bold hover:underline flex items-center gap-1">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              We know it's hard to visualize the final product. That's why we offer a <strong>completely free mockup</strong> of your website and brand style before development even begins.
            </p>
            <a 
              href="#contact" 
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-gray-600 text-lg">A glimpse into the digital experiences and visual identities we've crafted for our clients.</p>
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Portfolio Items using Unsplash placeholders */}
            <PortfolioCard 
      ...
      <section id="process" className="py-24 bg-purple-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-lg">A simple, transparent process designed to get you online quickly and effectively.</p>
          </div>
      ...
      <section id="pricing" className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-lg">High-quality digital services tailored to your specific needs and scope.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="p-8 rounded-2xl border border-gray-100 bg-gray-50 flex flex-col">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Deep-dive strategy session</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Digital audit</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Actionable roadmap</li>
              </ul>
            </div>
            ...
            <div className="p-8 rounded-2xl border-2 border-purple-600 bg-white shadow-xl shadow-purple-100 flex flex-col relative transform md:-translate-y-4">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-purple-600 text-white px-4 py-1 rounded-full text-sm font-bold">Most Popular</div>
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Custom design & development</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Mobile responsive</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> SEO basics included</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Free initial mockup</li>
              </ul>
              <a href="#contact" className="w-full block text-center bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 rounded-lg transition-colors">Get a Quote</a>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-gray-100 bg-gray-50 flex flex-col">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Social media management</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Website maintenance</li>
                <li className="flex items-start gap-3 text-gray-600"><CheckCircle2 className="text-purple-600 shrink-0" size={20}/> Content creation</li>
              </ul>
              <a href="#contact" className="w-full block text-center bg-white border border-gray-300 hover:bg-gray-100 text-gray-900 font-bold py-3 rounded-lg transition-colors">Discuss Needs</a>
            </div>
          </div>
          <p className="text-center text-gray-500 text-sm mt-8">
            * Final pricing depends on project scope and specific requirements. Contact us for an accurate estimate.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                We believe that establishing a digital presence shouldn't be complicated. Our philosophy is simple: provide everything a modern business needs to succeed online, under one roof.
              </p>
              <p>
                Whether you are starting from scratch or looking to revamp your current identity, we act as your dedicated digital partners. We combine design, strategy, and technology to build trust with your audience.
              </p>
              <p className="font-semibold text-white">
                Make today Day One of your digital growth.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="p-10 lg:p-12 bg-purple-700 text-white lg:w-5/12 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-10 text-purple-100">
                  Ready for your free mockup? Or just have a question? Drop us a message and we'll get back to you within 24 hours.
                </p>
                
                <div className="space-y-6">
                  <a href="tel:+1234567890" className="flex items-center gap-4 hover:text-purple-200 transition group">
                    <div className="bg-purple-600 p-3 rounded-full group-hover:scale-110 transition-transform"><Phone size={20} /></div>
                    <span className="font-medium text-lg">+1 (234) 567-890</span>
                  </a>
                  <a href="mailto:hello@dayone.agency" className="flex items-center gap-4 hover:text-purple-200 transition group">
                    <div className="bg-purple-600 p-3 rounded-full group-hover:scale-110 transition-transform"><Mail size={20} /></div>
            ...
            <div className="p-10 lg:p-12 lg:w-7/12 bg-white">
              <form 
                onSubmit={(e) => { e.preventDefault(); alert('Form submitted! (Connect your API)'); }} 
                className="space-y-6"
              >
                <div>
                  <label className="block text-sm font-semibold mb-2 text-gray-700">Name</label>
                  <input type="text" className="w-full border border-gray-200 bg-gray-50 p-3.5 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 outline-none transition" placeholder="John Doe" required />
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-2 text-gray-700">Email Address</label>
                  <input type="email" className="w-full border border-gray-200 bg-gray-50 p-3.5 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 outline-none transition" placeholder="john@example.com" required />
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-2 text-gray-700">Message</label>
                  <textarea rows={4} className="w-full border border-gray-200 bg-gray-50 p-3.5 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 outline-none transition resize-none" placeholder="Tell us about your project or request a free mockup..." required></textarea>
                </div>
                <button type="submit" className="w-full bg-gray-900 hover:bg-purple-700 text-white font-bold py-4 rounded-xl shadow-lg transition-colors text-lg">
                  Send Message
                </button>
              </form>
            </div>
      ...
      <footer className="bg-white border-t border-gray-100 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-sm font-medium text-gray-500">
            ...
            <a href="#portfolio" className="hover:text-purple-700">Work</a>
